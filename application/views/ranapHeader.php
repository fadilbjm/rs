    ...
    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
      <div class="sidebar-sticky">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link " href="<?php echo base_url('ranap');?>">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url('ranap/regisranap');?>">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#<?php echo base_url('ranap/listranap');?>">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#<?php echo base_url('ranap/pasien');?>">
